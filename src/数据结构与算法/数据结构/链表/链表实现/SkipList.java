...
public class SkipList {
    ...
    public SkipNode search(int key) {
        ...
        while (team != null) {
            if (team.key == key) {
                return team;
            } else if (team.right == null || team.right.key > key) {//右侧没有了，只能下降,或者右值需要下降去寻找
                team = team.down;
            } else { //右侧比较小向右
                team = team.right;
            }
    ...
    public void add(SkipNode node) {
        ...
        while (team != null) {//进行查找操作
            if (team.right == null || team.right.key > key) {//右侧没有了，只能下降
