package 数据结构与算法.数据结构.树.平衡搜索树合集;

import org.junit.jupiter.api.DisplayName;
import org.junit.jupiter.api.Test;
import 数据结构与算法.数据结构.树.树实现.Node.BNode;
import 数据结构与算法.数据结构.树.树实现.平衡搜索树合集.BTree;
...
class TestBTree {
    ...
    void split1() {
        ...
        root.children[0] = new BNode(new int[]{1, 2, 3});
        root.children[0].keyNumber = 3;

        root.children[1] = new BNode(new int[]{6});
    ...
    void split2() {
        ...
        root.keys[0] = 6;
        root.keyNumber = 1;
        root.children[0] = new BNode(new int[]{1, 2, 3, 4, 5});
        root.children[0].keyNumber = 5;

        root.children[1] = new BNode(new int[]{7});
        root.children[1].keyNumber = 1;
