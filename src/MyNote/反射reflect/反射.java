...
public class 反射 {
    ...
    public static void main(String[] args) throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchFieldException {
        ...
        Class<?> class1 = Class.forName("MyNote.反射reflect.Student");//最常用
        ...
        for (Constructor<?> con:constructors1){
            ...
            //public MyNote.反射reflect.Student(java.lang.String,int)
            //public MyNote.反射reflect.Student()
        }
        System.out.println("------------------------");
        Constructor<?>[]constructors2= class1.getDeclaredConstructors();
        for (Constructor<?> con:constructors2){
            System.out.println(con);//获取顺序随机
            //protected MyNote.反射reflect.Student(int)
            //public MyNote.反射reflect.Student(java.lang.String,int)
            //private MyNote.反射reflect.Student(java.lang.String)
            //public MyNote.反射reflect.Student()
        }
        System.out.println("------------------------");
        //获取单个指定类型的公共构造方法,不传参则获取无参构造
        Constructor<?> constructors3= class1.getConstructor(String.class,int.class);
        System.out.println(constructors3);//public MyNote.反射reflect.Student(java.lang.String,int)
        //获取单个指定参数类型的构造方法
        Constructor<?> constructors4= class1.getDeclaredConstructor(String.class);
        System.out.println(constructors4);//private MyNote.反射reflect.Student(java.lang.String)
        ...
        for (Field f:fields){
            ...
            //public java.lang.String MyNote.反射reflect.Student.name
        }
        System.out.println("---------------------------");
